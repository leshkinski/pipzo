...
The goal is a calm touchscreen-first bedside player: no phone for playback, no general desktop access, true fullscreen kiosk mode for daily use, large touch targets, simple Spotify library browsing on Home, Bluetooth speaker output, and a low-light bedtime mode.
